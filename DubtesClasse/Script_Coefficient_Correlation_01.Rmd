...
my_data <- read.table("marker1.csv", header = TRUE, sep = ",", quote = "\"’", dec = ".")
my_data
cor(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB)
(test <- cor.test(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB))
...
```{r}
plot(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB)
abline(lm(RESULT_marker1_methodB~ RESULT_marker1_methodA,data=my_data) )
```
...
# library(pspearman)
# spearman.test(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB, approximation = "exact")

cor(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB, method = "spearman")
(test <- cor.test(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB, method = "spearman"))
```
...
```{r}
library(epiR)
epi.ccc(my_data$RESULT_marker1_methodA, my_data$RESULT_marker1_methodB, ci = "z-transform", conf.level = 0.95, rep.measure = FALSE, subjectid)
help(epi.ccc)
```
